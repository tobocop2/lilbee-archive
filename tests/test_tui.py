...
class TestNoRichConsoleInTui:
    ...
    def test_chat_add_registers_without_pulling_in_console(self) -> None:
        import inspect
        ...
        assert "register_paths" not in source  # the Console-printing CLI helper
        assert "register_sources" in source
