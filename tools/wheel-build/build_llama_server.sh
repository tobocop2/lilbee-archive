...
# keys on it: a cu125 wheel and a Vulkan wheel of identical versions must not alias).
...
ENGINE_PIN = "llama-cpp-${version}+swap-${ENGINE_LLAMA_SWAP_VERSION}+gguf-${ENGINE_GGUF_PARSER_REF}+${backend}"
PINS
